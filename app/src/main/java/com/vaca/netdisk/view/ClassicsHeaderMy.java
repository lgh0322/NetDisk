...
public class ClassicsHeaderMy extends InternalClassics<ClassicsHeaderMy> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public ClassicsHeaderMy(Context context) {
        this(context, null);
    }

    public ClassicsHeaderMy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ClassicsHeaderMy(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        final DensityUtil density = new DensityUtil();
        ...
        lpUpdateText.topMargin = ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextTimeMarginTop, SizeUtils.dp2px(0));
        lpProgress.rightMargin = ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlDrawableMarginRight, SizeUtils.dp2px(20));
//        lpArrow.rightMargin = lpProgress.rightMargin;
        ...
        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTitle, SizeUtils.dp2px(16)));
//        } else {
//            mTitleText.setTextSize(16);
        }

        if (ta.hasValue(R.styleable.ClassicsHeader_srlTextSizeTime)) {
            mLastUpdateText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsHeader_srlTextSizeTime, SizeUtils.dp2px(12)));
//        } else {
...
//        mProgressView.setVisibility(GONE);
    ...
    public ClassicsHeaderMy setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public ClassicsHeaderMy setTimeFormat(DateFormat format) {
    ...
    public ClassicsHeaderMy setLastUpdateText(CharSequence text) {
        mLastTime = null;
        mLastUpdateText.setText(text);
        return this;
    }

    public ClassicsHeaderMy setAccentColor(@ColorInt int accentColor) {
        mLastUpdateText.setTextColor(accentColor&0x00ffffff|0xcc000000);
        return super.setAccentColor(accentColor);
    }

    public ClassicsHeaderMy setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
...
//            mRefreshKernel.requestRemeasureHeightForHeader();
    ...
    public ClassicsHeaderMy setTextSizeTime(float size) {
...
//    }
    ...
    public void setTextPulling(String textPulling) {
        mTextPulling = textPulling;
    }

    public void setTextRefreshing(String textRefreshing) {
    ...
    public void setTextFinish(String textFinish) {
